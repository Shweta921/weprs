...
<!-- /page content -->
 ...
 <div class="row">
            ...
            <input class="form-control"  name="pstation" type="hidden" value="<?php echo $SalesId;?>" readonly>
                        
			<?php 
		$spdata=mysql_fetch_array(mysql_query("SELECT * FROM pstation WHERE Id='$SalesId'"));
		$SPId=$spdata['SPId'];
		?>

            <input class="form-control"  name="spoffice" type="hidden" value="<?php echo $SPId;?>" readonly>
