              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    ...
                    <ul class="nav child_menu">
                  <li><a href="<?php echo $_SESSION['base_url']?>/ps/purchase_order.php?id=0">Create Police Station RO</a></li>
                  <li><a href="<?php echo $_SESSION['base_url']?>/ps/view_ro.php">View PS RO</a></li>
