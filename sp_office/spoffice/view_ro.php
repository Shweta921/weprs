  		...
  		<form id="studReport"  method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
            ...
            <div class='col-md-3 col-sm-3 col-xs-12' >
                 ...
                 <option value="All">All </option>
                  <?php
								$resull=mysql_query("select * from `spofficero` WHERE `spoffice`='$SalesId' GROUP BY `challan`");
...
$fsql="SELECT * FROM `spofficero` WHERE  `date` BETWEEN '$edate1' AND '$edate2' GROUP BY `challan` ORDER BY `challan`";
 ...
 $rss=mysql_fetch_array(mysql_query("select * from spoffice where `Id`='$spoffice'"));
	...
	<a style='color:black;' class='pull-right col-xs-1' target='_blank' href='rochallan.php?challan=$fchlln'> View </a>
	</td>
							</tr>";

					echo "<tr style='font-weight:bold; text-align:center;'>
	<td colspan='6'> <a >Date:- $cdate, SP Office:- $vname </a></td></tr>";
...
$fdata=mysql_fetch_array(mysql_query("SELECT * FROM `spofficero` WHERE `challan`='$challan'"));
