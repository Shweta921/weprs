...
<div style="">
	...
	$qrysch=mysql_fetch_array(mysql_query("select * from spstock WHERE `PCode`='$row[PCode]'"));
...
if($irr)
{
	$upqry=mysql_query("update pstationpo SET `Status`='1' where challan=$challan");
