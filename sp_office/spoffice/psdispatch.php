...
<!-- /page content -->
 ...
 <div class="row">
	...
	$dispchlndata=mysql_fetch_array(mysql_query("SELECT * FROM psdispatchtemp WHERE `po`='$pochln'"));
...
<?php
    $cds=mysql_num_rows(mysql_query("SELECT * FROM `psdispatchtemp` WHERE `login`='$login' AND `po`='$pochln'"));
                            if($cds!=0)
{
?>
 <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead>
		               ...
		               <tbody>
             <?php
$rssw=mysql_fetch_array(mysql_query("SELECT * FROM `psdispatchtemp` WHERE `login`='$login'  AND `po`='$pochln'"));
					$date1=$rssw['date'];
					$date2=$rssw['date2'];
					$SPID=$rssw['spoffice'];
					$PSID=$rssw['pstation'];
 ...
 $rss2=mysql_fetch_array(mysql_query("select * from pstation where `Id`='$PSID'"));
	...
	<td colspan='4'> <a >SPORO No:- $pochln, PO Date:- $date1, Dispatch Date:- $date2, SP Office:- $Dname, Police Station:- $PSName </a></td></tr>";



				$sql="SELECT * FROM `psdispatchtemp` WHERE `login`='$login'  AND `po`='$pochln' GROUP BY `PCode`";
				$res=mysql_query($sql);
					$Count2=0;
					$i=1;
				...
				$PCode=$data['PCode'];
				$sql2="SELECT * FROM `psdispatchtemp` WHERE `PCode`='$PCode' AND `login`='$login'  AND `po`='$pochln'";
...
<td colspan='2'><strong>Grand Total</strong></td>
			...
			?>
                  ...
                  <form action="savepsdispatch.php" class="form-horizontal form-label-left" method="post"  name="form1">
