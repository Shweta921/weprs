...
<html lang="en">
  <head>
    ...
    <title>Assam Police| Edit Purchase Order </title>
...
$Vidata=mysql_fetch_array(mysql_query("select * from potemp2 where `challan`='$_SESSION[id1]' AND `login`='$login'"));
$Vid=$Vidata['vendor'];
$date=$Vidata['date'];
 ...
 <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post"  action="savetemppo2.php" >
			
            		<div class="item form-group">
                        <label class="control-label col-md-2 col-sm-2 col-xs-6" for="name">Purchase No. <span class="required">*</span>
                        </label>
...
<?php
                            $cds=mysql_num_rows(mysql_query("SELECT * FROM `potemp2` WHERE `login`='$login'"));
                            if($cds!=0)
{
?>
 <div class="col-md-12 col-sm-12 col-xs-12">
             ...
             <?php
				...
				$sql="SELECT * FROM `potemp2` WHERE `login`='$login'";
				$res=mysql_query($sql);
					$Count=0;
					$i=1;
					$TAmount=0;
...
$TAmount=$TAmount+$Amount;			
			...
			?>
                  ...
                  <form action="makepoch2.php" method="post"  name="form1">
                <input type="hidden" value="<?php echo $_SESSION['id1'];?>" name="challan">
		       
	             <button type='submit' class='btn btn-primary' name='submit2'>Update PO</button>
				</form> 
                </div>
              </div>
