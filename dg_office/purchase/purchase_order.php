...
<html lang="en">
  <head>
    ...
    <title>Assam Police| Add Purchase Order </title>
...
<?php
                            $cds=mysql_num_rows(mysql_query("SELECT * FROM `potemp` WHERE `login`='$login'"));
                            if($cds!=0)
{
?>
 <div class="col-md-12 col-sm-12 col-xs-12">
             ...
             <?php
				...
				$sql="SELECT * FROM `potemp` WHERE `login`='$login'";
				$res=mysql_query($sql);
					$Count=0;
					$i=1;
					$TAmount=0;
