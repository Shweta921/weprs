...
<html lang="en">
  <head>
    ...
    <title>Assam Police| Edit SP Office </title>
...
require_once("../menu.php");
	...
	$id=$_GET['id'];
$res=mysql_query("SELECT * FROM `spoffice` WHERE `Id`='$id'");
...
<!-- /page content -->
 ...
 <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Edit SP Office</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
          <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post"  action="update_dist.php" >
...
?>
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="CName" class="form-control col-md-7 col-xs-12" value="<?php echo $user;?>" data-validate-length-range="6" name="user" required type="text">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label for="password" class="control-label col-md-3">Password</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="password" type="password" name="password" value="<?php echo $password;?>" data-validate-length="6,8" class="form-control col-md-7 col-xs-12" required>
