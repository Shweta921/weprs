 ...
 <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post"  action="saveproduct.php" >
                 ...
                 <option value="Ammunations">Ammunations</option>
                      ...
                      <div class='form-group'>
                        ...
                        <div class='col-md-6 col-sm-6 col-xs-12'>
                          <input id='mid' required class='form-control col-md-7 col-xs-12' type='text' name='PName'>
                        </div>
                      </div>
                   ...
                   <div class='form-group'>
                        ...
                        <div class='col-md-6 col-sm-6 col-xs-12'>
                          <input id='mid' required class='form-control col-md-7 col-xs-12' type='text' name='PRate'>
                        </div>
                      </div>
                      ...
                      <div class='form-group'>
                        ...
                        <div class='col-md-6 col-sm-6 col-xs-12'>
                          <input id='mid' required class='form-control col-md-7 col-xs-12' type='text' name='GST'>
                        </div>
                      </div>
                      ...
                      <div class='form-group'>
                        ...
                        <div class='col-md-6 col-sm-6 col-xs-12'>
                          <input id='mid' required class='form-control col-md-7 col-xs-12' type='text' name='HSN'>
                        </div>
                      </div>
