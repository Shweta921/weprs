...
<html lang="en">
  <head>
    ...
    <title>Assam Police| View SP Office  </title>
...
<script>
    ...
    if (answer) {	
	location.href = 'deletedist.php?link='+id;
				}
	}
...
<!-- /page content -->
 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
             ...
             <?php
				...
				$sql="SELECT * FROM `spoffice` WHERE `status`='0'";
			$res=mysql_query($sql);
					$Count1=0;
...
$password=$data['password'];
					...
					<td><a href='javascript:void(0);' onclick='javascript:confirmclick(1,".$id.")'>
									<img src='../images/b_drop.png' title='Delete'>Delete</a> <a href='edit_dist.php?id=".$id."'>
