...
<html lang="en">
  <head>
    ...
    <title>Assam Police| View Product </title>
...
<script type="text/javascript">
    ...
    if (answer) {	
	location.href = 'deleteproduct.php?link='+id;
				}
	}
...
<!-- /page content -->
 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
			...
			$GST=$data['GST'];
					...
					<td>".$PRate."</td>
					<td>".$GST."</td>
					<td><a href='deleteproduct.php?link=".$id."'>
									<img src='../images/b_drop.png' title='Delete'>Delete</a> <a href='edit_product.php?id=".$id."'>
