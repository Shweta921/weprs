 ...
 <div class="row">
          ...
          <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post"  action="<?php echo $_SERVER['PHP_SELF'];?>" >
             <div class="item form-group">
        	              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="textarea">SP Office: <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
		<select name="spoffice" id="spoffice" class="form-control" required>
     <option value="">Select SP Office</option>
                  <?php
								$resull=mysql_query("select * from spoffice WHERE `Status`=0");
