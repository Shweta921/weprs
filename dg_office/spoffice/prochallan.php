...
<title>Purchase Order Challan</title>
</head>
<style>
...
<?php
		 ...
		 $r=mysql_fetch_array(mysql_query("select * from pstationpo where `challan`='$challan'"));
						 $DID=$r['spoffice'];
						 $RID=$r['pstation'];
						 $edate=$r['date'];
						 $Poch=$r['po'];
...
<div style="">
      <table align="center" width="100%" style="border-collapse:collapse;" border="1px">
        ...
        <td align="center" colspan="3" style="color:blue; border-color:#000;"><font size="3"><?php echo $addr; ?></font></td>
      	...
      	<tr style="font-size:15px;">
     				 <td   width="37%" style="padding:5px; text-transform:capitalize;" >SP Office Details:
					...
					?><br />
     				 ...
     				 <td   width="37%" style="padding:5px; text-transform:capitalize;" >Police Station Details:
					 <?php
					...
					?><br />
                     ...
                     PRO No :&nbsp; <strong>PRO-<?php echo $chaln;?></strong><br />
    ...
    <table align="center" width="100%" style="font-family:Arial, Helvetica, sans-serif;border-collapse:collapse;" border="1px">
		  ...
		  <tr style="background:#f3f8f4; font-size:13px" >
			 <th  width="auto" align="center" colspan="4">Retail Purchase Order Sheet</th>
		  </tr>
		  <tr style="background:#f3f8f4; font-size:13px" >
			 <th  width="auto" align="center" rowspan="1">Sr <br />No.</th>
			 <th  width="auto" align="center" rowspan="1">Category</th>
			 ...
			 <th  width="auto" align="center" rowspan="1">Qty</th>
				 ...
				 <?php
	  $r=mysql_query("select * from `pstationpo` where `challan`='$challan' ");
				...
				$tqty=0;
				 ...
				 {
					 $pqty=0;
	$irr=mysql_query("select * from `pstationpo` where `challan`='$challan' AND `PCode`='$row[PCode]' ");
...
For <strong style="text-transform:uppercase;"><?php echo $FName; ?></strong>
      </div>
...
$_SESSION['po']=$_SESSION['podate']=$_SESSION['spoffice']=$_SESSION['id1']=$_SESSION['Nch']="";
}
