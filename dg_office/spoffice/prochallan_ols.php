...
<?php
					$challan=$_GET['challan'];
						...
						$rj=mysql_query("select * from pstationpo where challan=$challan");
      ...
      <tr>
        ...
        <td align="center" colspan="2" style="border-bottom:solid 1px #000000; color:blue;"><font size="2">DG OFFICE ADDRESS  DG OFFICE ADDRESS  DG OFFICE ADDRESS  </font></td>
      	...
      	<tr style="font-size:13px;">
     				 <td><big>Police Station Name :- </big><z><strong>
					 <?php
					// $row = mysql_fetch_array(mysql_query("select  distinct vendor from `pstationpo` where `challan`='$challan'"));
					 $rss=mysql_fetch_array(mysql_query("select * from pstation where `Id`='$psid'"));
					 $PSName=$rss['PSName']; 
