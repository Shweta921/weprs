  		...
  		<form id="studReport"  method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
            ...
            <div class='col-md-3 col-sm-3 col-xs-12' >
                 ...
                 <option value="All">All</option>
                  <?php
								$resull=mysql_query("select * from dispatch GROUP BY `challan`");
...
/*echo "<a style='color:black;' class='pull-right  col-xs-1' href='javascript:void(0);' onclick='javascript:confirmclick(1,".$fchlln.")'>
