...
<html lang="en">
  <head>
    ...
    <title>ASSAM POLICE| View SP Office RO</title>
...
<script>
    ...
    if (answer) {	
	window.open('sprochallan.php?challan='+id,'_blank');
...
////////////////////////////////////////All Site report //////////////////////////////////////////////////////////
 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
           <h2> New SP Office Request Order</h2>
        ...
        <table id="datatable-buttons" class="table table-striped table-bordered">
			...
			$fsql="SELECT * FROM `spofficero` WHERE  `Status`=0 GROUP BY `challan` ORDER BY `challan`";
...
<a style='color:white; font-weight:bold;' class='btn btn-success pull-right col-xs-2' target='_blank' href='rochallan.php?challan=$fchlln'> Print PO </a>
	</td>
							</tr>";

echo "<tr style='font-weight:bold; text-align:center;'>
	<td colspan='2'> <a >Date:- $cdate, SP Office:- $spoffice </a></td></tr>";

$sql="SELECT * FROM `spofficero` WHERE `Status`=0 AND `challan`='$fchlln' GROUP BY `PCode`";
			$res=mysql_query($sql);
			$CCount1=0;
			while($data=mysql_fetch_array($res)){
			
			$PCode=$data['PCode'];
			$sql2="SELECT * FROM `spofficero` WHERE  `Status`=0 AND `PCode`='$PCode' AND `challan`='$fchlln' ";
