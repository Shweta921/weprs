...
<html lang="en">
  <head>
    ...
    <title>Assam Police | View SP Office Stock </title>
...
<!-- /page content -->
  ...
  <div class="row">
      ...
      <div class="form-group row">
                        ...
                        <select name="DID" id="vendor" class="form-control col-md-2 col-sm-2" required>
				<option value="">Select SP Office</option>
			<?php 
		$query =mysql_query("SELECT * FROM spoffice WHERE status=0");
		while($row=mysql_fetch_array($query))
			...
			?>
                 ...
                 <option value="Ammunations">Ammunations</option>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-6">
                       		<select  class="form-control" onChange="selectAdds(this.options[this.selectedIndex].value)" name="PCode" id="product" >
